...
switch (cmd)
{
    case "bench":
        Run("dotnet",
            "run --project src/Maple.Process.Benchmarks/Maple.Process.Benchmarks.csproj"
    ...
    case "comparison-bench":
        Run("dotnet",
            "run --project src/Maple.Process.ComparisonBenchmarks/Maple.Process.ComparisonBenchmarks.csproj"
            + " -c Release -- run",
            repoRoot);
        break;
    ...
    case "disasm":
        Run("dotnet",
            "run --project src/Maple.Process.Benchmarks/Maple.Process.Benchmarks.csproj"
            + " -c Release -- --filter \"*Maple.Process*\" --disasm",
            repoRoot);
        break;
    ...
    case "publish-tester":
        ...
        Run("dotnet",
            $"publish src/Maple.Process.Tester/Maple.Process.Tester.csproj -c Release -r {rid} --self-contained",
            repoRoot);
        break;
